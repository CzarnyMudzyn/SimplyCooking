...
<div class="row2">
	<div class="col-sm">
		<div class="przepis">
			<center><h1>Ciastka maślane</h1></center>
			</div>
</div>
</div>
<div class="row2">
  ...
  <li class="list-group-item">Składniki na ciasto kruche zagnieść na jednolitą masę. (Masło pokroić uprzednio na małe kawałki). Owinąć w folię spożywczą i wstawić do lodówki na ok. 1 godzinę.</li>
  <li class="list-group-item">Schłodzone ciasto krótko zagnieść i rozwałkować na posypanym mąką blacie na grubość ok. 5 mm. Z ciasta wykrawać dowolne kształty foremką i układać je w odstępach na blasze wyłożonej papierem do pieczenia. (Wychodzą 3 blachy ciasteczek).</li>
  <li class="list-group-item">Piec w nagrzanym piekarniku ok. 10 minut, jedną blachę po drugiej, w temperaturze 180°C (grzałka góra- dół), aż ciasteczka lekko się przyrumienią. Po upieczeniu pozostawić do ostygnięcia.</li>
...
$(document).ready(function(){
    ...
    <tbody>
      <tr>
        <td><p>250g mąki pszennej</p></td>
        
      </tr>
      <tr>
        <td><p>90g cukru pudru></td>
