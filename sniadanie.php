...
<div class="nawigacja"> 	
	<div class="card" style="width: 18rem;">
		<img class="card-img-top" style="height: 160px;" src="http://www.fit.pl/img/2016/01/musli(1).jpg" alt="Card image cap">
	<div class="card-body">
		<h5 class="card-title">Musli</h5>
		<p class="card-text">Mieszanka płatków zbożowych, owoców i bakalii, czyli popularne musli może być źródłem cennych witamin</p>
		<a href="musli.php" class="btn btn-primary">Zjem!</a>
	</div>
	</div>
</div>
</center>
