...
<div class="nawigacja"> 	
	<div class="card" style="width: 18rem;">
		<img class="card-img-top" style="height: 160px;" src="http://bi.gazeta.pl/im/77/e7/14/z21920375Q,Jak-zrobic-jajko-w-koszulce-.jpg" alt="Card image cap">
	<div class="card-body">
		<h5 class="card-title">Jajko w koszulce</h5>
		<p class="card-text">Jajko gotowane bez skorupki w wodzie, do momentu ścięcia się białka.</p>
		<a href="jajko.php" class="btn btn-primary">Zjem!</a>
	</div>
	</div>
</div>
</center>
