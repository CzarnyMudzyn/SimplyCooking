...
<center><h2>Przepisy PREMIUM </h2></center>
...
<div class="nawigacja"> 	
	<div class="card" style="width: 18rem;">
		<img class="card-img-top" style="height: 160px;" src="http://kulinarnapiniata.pl/wp-content/uploads/2013/09/DSC0126.jpg" alt="Card image cap">
	<div class="card-body">
		<h5 class="card-title">Ciastka babuni</h5>
		<p class="card-text">Pyszne maślane ciastka z odrobiną miłości. </p>
		<a href="ciastko.php" class="btn btn-primary">Zjem!</a>
	</div>
	</div>
</div>
</center>
